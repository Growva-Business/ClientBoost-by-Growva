...
export function ClientsPage() {
  ...
  const { salonProfile, clients, fetchData } = useBookingStore();
  ...
  if (!salonProfile) return <div className="p-10 text-center">Loading Clients... 👥</div>;
...
<div className="relative max-w-md">
        ...
        <input 
          ...
          // 🧸 Using 'cn' here clears the warning (Error 6133)
          className={cn(
